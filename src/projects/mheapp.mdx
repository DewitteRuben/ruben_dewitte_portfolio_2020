...
As part of my <MdLink href={`${process.env.PUBLIC_URL}/RubenDewitte.pdf`}>bachelor thesis</MdLink>, I developed a proof of concept of a system that could aid mental health professionals with the follow-up of their clients.
