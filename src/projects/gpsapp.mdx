...
thumb: https://i.imgur.com/Fkfjd9H.jpg
yPosThumb: 63%
---
...
* React Native WebRTC for peer to peer video and audio streaming
* Firebase's Realtime Database for the transmission of location data
* NodeJS Express with Socket.io for the STUN and TURN setup needed for WebRTC
* Heroku to host the web app for this project
* Typescript for both front and back-end
