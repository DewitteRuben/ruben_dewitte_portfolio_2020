...
Users have the ability to share a passcode, that is unique to them, with the people they want to be tracked by. This passcode can in turn be used by others to track the tracker.
...
This id can be used to view the GPS location of the person concerned using the standalone <MdLink href="https://gpsapp-server.herokuapp.com/">web application</MdLink>.
